...
var LR_lxurl = 'http://pqt.zoosnet.net/';
var LR_fd573='957A71174DFF4421877C1979EB617FEF';var LR_websiteid = 'PQT43116159';
var LiveReceptionCode_isonline = 1;
var LR_ssl = 0;
var LR_imgurl = 'http://pqt.zoosnet.net/';
var LR_sysurl = 'http://pqt.zoosnet.net/';
LR_fd573=((3+1).toString()+LR_fd573+(3*1).toString());LR_fd573=LR_fd573.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_isMobile = 0;
var LR_66b6f=LR_fd573.replace(/1/g,'3').replace(/0/g,'2');var LR_JEAF=LR_66b6f.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_top=((typeof(LiveReceptionCode_helpimgtop)!='undefined')?LiveReceptionCode_helpimgtop:50);
	var _lr_issupport_track= LiveReceptionCode_isonline;
	LR_hasInstall=0;
	var LR_ivite_img='http://pqt.zoosnet.net/site/43116159/invite_share.jpg';
	...
	var LR_invitestring1_auto=unescape("%3cP%3e%3cSTRONG%3e%3cFONT size%3d4%3e%u60a8%u597d%uff01%u5317%u7586%u91d1%u79cb%uff0c%u989d%u6d4e%u7eb3%u65d7%uff0c%u575d%u4e0a%u79cb%u6444%uff0c%u8d35%u5dde%u5168%u666f%u7b49%u91d1%u724c%u7ebf%u8def%u5747%u5df2%u4e0a%u7ebf%uff0c%u6700%u7f8e%u7684%u5b63%u8282%uff0c%u5e26%u60a8%u53bb%u6700%u7f8e%u7684%u5730%u65b9%uff01%3c%2fFONT%3e%3c%2fSTRONG%3e%3c%2fP%3e");
	...
	var LR_pm011=0;
	var LR_pm012=30;
	function minichathtml(islrminimin) {return '<div style=\"width:400px; height:390px;'+(islrminimin?'display:none;':'')+'\" id=\"LRMINIWIN\"><div style=\"z-index: 2147483647; position: absolute; width: 400px; height: 30px; overflow: hidden; display: block;\" id=\"LRMINIWIN0\"><span style=\"float:left;clear:none; width:103px;height:20px; overflow:hidden; margin:0 5px;\"></span><span onclick=\"lr_closemini();\" style=\"CURSOR:pointer;float:right;clear:none; width:20px;height:20px; margin:6px 1px 0 0; overflow:hidden;\"><img border=\"0\" src=\"http://kllife.com/swt/images/close.png\" style=\"cursor:pointer;\"></span><span onclick=\"openZoosUrl(\'bchatwin\');lr_hidemini();\" style=\"CURSOR:pointer;float:right;overflow:hidden;width:20px;height:20px;clear:none;display:bolck;margin:6px 2px 0 0;\"><img border=\"0\" style=\"cursor:pointer;\" src=\"http://kllife.com/swt/images/big.png\"></span><span onclick=\"lrminiMin();\" style=\"CURSOR:pointer;float:right;overflow:hidden;width:20px;height:20px;clear:none;display:bolck;margin:6px 2px 0 0;\"><img border=\"0\" style=\"cursor:pointer;\" src=\"http://kllife.com/swt/images/small.png\"></span></div><iframe id=\"LR_miniframe\" name=\"LR_miniframe\" width=\"100%\" height=\"390px\" frameborder=\"0\" scrolling=\"No\" allowtransparency=\"true\" src=\"' + LR_sysurl +'JS/im1.aspx\"></iframe></div>';}
	function minibarhtml(islrminimin) {return '<div id=\"LRMINIBar\" style=\"'+(!islrminimin?'display:none;':'')+'width:318px;height:39px;cursor:pointer; background-image:url(http://kllife.com/swt/images/narrow.png);\" onclick=\"lrminiMax();document.getElementById(\'LRMINIWIN\').style.width =\'400px\';\"></div>';}
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&DIFD='+LR_JEAF;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="http://pqt.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
